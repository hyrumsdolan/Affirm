...
async function claudeAPICall(input) {
  ...
  const msg = await anthropic.messages.create({
    ...
    I have raveled to new countries and experienced different cultures | I launch my own business and become an entrepreneur | I am fit and prioritize health through better diet and consistent exercise

    The goal is to succinctly capture the essence of what matters most to the user based on what they share and keep it concise as possible without losing meaning (try to keep each one to 5-7 words max, and the goal is to have a least 10 distinct dream/goal/idea without making anything up the user didn't say or obviously insinuate). Say nothing else other than the summary of the goals in first person and past tense, as if they've already accomplished their goal. Remember to keep each idea distinct and separated by pipes.`,
